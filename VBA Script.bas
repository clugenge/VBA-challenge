    ...
    For Each ws In Worksheets
        ...
        For i = 2 To LastRow
            ...
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                'Input the Yearly Change values onto Column J
                
                ws.Range("J" & Summary_Table_Row).Value = Yearly_Change
                
                    'Create a Nested If argument to Calculate the Percent Change.
        ...
        For k = 2 To LastRow
            ...
            If ws.Cells(k, 11).Value > Result_1 Then
                ...
                Answer1 = ws.Cells(k, 11).Value
                ws.Range("P2").Value = Answer1
        ...
        For l = 2 To LastRow
            ...
            If ws.Cells(l, 11).Value < Result_2 Then
                ...
                Answer2 = ws.Cells(l, 11).Value
                ws.Range("P3").Value = Answer2
        ...
        For m = 2 To LastRow
            ...
            If ws.Cells(m, 12).Value > Result_3 Then
                ...
                Answer3 = ws.Cells(m, 12).Value
                ws.Range("P4").Value = Answer3
